...
export const translations: Record<string, { en: string; es: string }> = {
  ...
  "hero.subtitle": {
    en: "ReceptionAI answers calls, texts, web chats, and messages — in English and Spanish — schedules appointments, sends reminders, and transfers to your team when needed. Everything a $55,000 receptionist does. Never sick. Never late. Always on. $99/month.",
    es: "ReceptionAI responde llamadas, textos, chats web y mensajes — en inglés y español — agenda citas, envía recordatorios y transfiere a tu equipo cuando sea necesario. Todo lo que hace un recepcionista de $55,000 al año. Nunca se enferma. Nunca llega tarde. Siempre disponible. $99/mes.",
  },
  "hero.cta": {
    en: "Start Free Trial",
    es: "Prueba Gratis",
